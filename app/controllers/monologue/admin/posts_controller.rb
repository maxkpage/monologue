...
private
  ...
  def post_params
    params.require(:post).permit(:published, :tag_list,:title,:content,:url,:published_at, :title_tag_content, :meta_description_content, :meta_keywords_content, :share_img_url)
  end
end
